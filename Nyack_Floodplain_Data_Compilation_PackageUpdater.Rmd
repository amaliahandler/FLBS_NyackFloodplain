...
This code has been modified from the following script:

Nyack_Floodplain_Data_Compilation.Rmd

which was originally developed to compile Nyack RiverNet data from the start of the RiverNet monitoring project to 2019-06-25.

The code below has been modified in order to append newer data to the original RiverNet data so that data package updates can occur.
