...
file.copy(from = './Data/Nyack_do_2013-2019_cleaned.csv', 
          to   = './Nyack_Water_EML/data_objects')
file.copy(from = './Data/Nyack_cond_2013-2019_cleaned.csv', 
          to   = './Nyack_Water_EML/data_objects')
file.copy(from = './Data/Nyack_level_2013-2019_cleaned.csv', 
          to   = './Nyack_Water_EML/data_objects')
...
template_table_attributes(
  ...
  data.table = c('Nyack_do_2013-2019_cleaned.csv', 
                 'Nyack_cond_2013-2019_cleaned.csv',
                 'Nyack_level_2013-2019_cleaned.csv',
...
make_eml(
  ...
  dataset.title = 'Nyack Floodplain RiverNet surface water and groundwater dissolved oxygen, conductivity, water level, and temperature Northwest Montana, USA, 2012-2020',
  ...
  data.table = c('Nyack_do_2013-2019_cleaned.csv',
                 ...
                 'Nyack_water_sensor_details.csv', 
                 'HA_Water_Data_Raw.csv'),
  data.table.description = c('Cleaned dissolved oxygen data data', 
                             'Cleaned conductivity data', 
                             'Cleaned water level data', 
                             'Sensor details', 
                             'Raw water data'),
  other.entity = c('Nyack_Floodplain_Water_QAQC.Rmd', 
                   'HA_Field_Log.xlsx'),
  other.entity.description = c('Water data QAQC script', 
                               'Sensor service field notes'),
  provenance = 'edi.416.2',
  user.id = c('amaliahandler', 'nyackedi2020'),
