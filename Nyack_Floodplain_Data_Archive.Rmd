...
anom_zeros <- rbind(anom_zeros[[1]], anom_zeros[[4]], anom_zeros[[5]])
...
do_vis <- split(compiled_do_data, f = as.factor(compiled_do_data$sensor_number))
...
plot(do_vis[[1]]$datetime, do_vis[[1]]$do_conc, pch = 20, xlim = xlims)

xlims <- as.POSIXct(c('2014-04-09 00:00', '2014-04-11 00:00'))
ylims <- c(4, 12)
plot(do_vis[[1]]$datetime, do_vis[[1]]$do_conc, pch = 20, xlim = xlims, ylim = ylims)

xlims <- as.POSIXct(c('2014-09-13 00:00', '2014-09-17 00:00'))
ylims <- c(3.5, 11)
plot(do_vis[[1]]$datetime, do_vis[[1]]$do_conc, pch = 20, xlim = xlims, ylim = ylims)

plot(do_vis[[1]]$datetime[-which(do_vis[[1]]$do_temp == -999)], 
     do_vis[[1]]$do_temp[-which(do_vis[[1]]$do_temp == -999)], 
