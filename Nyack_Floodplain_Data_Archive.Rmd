...
sensor_service_cond <- sensor_service[, c('site','sensor_number','datetime','cond','ct','cond_temp')]
...
casc_silt_cond           <- casc_silt[, c('site','sensor_number','datetime',
                                          'cond','ct','cond_temp')]
casc_silt$flag_cond      <- 2
casc_silt$flag_cond_temp <- 2
...
flag_data_cond$flag_cond      <- 1
flag_data_cond$flag_cond_temp <- 1
