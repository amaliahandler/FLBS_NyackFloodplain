...
lapply(do_vis, function(x){
  # All the do concentration data
  plot(x$datetime, x$do_conc, 
       xlab = " ", ylab = y_label, cex.lab = 2, cex.axis = 2, pch = 20, cex.pch = 2)

  # Highlight flagged data
  points(x$datetime[which(x$flag == 9)],
         x$do_conc[which(x$flag == 9)],
         pch = 1, cex.pch = 2, col = 'red')
  
  # Highlight data IDed as bad from the temperature data
  points(x$datetime[which(x$do_temp == -999)],
         x$do_conc[which(x$do_temp == -999)],
         pch = 1, cex.pch = 2, col = 'blue')
...
points(x$datetime[which(x$flag == 9)], x$do_conc[which(x$flag == 9)], pch = 1, col = 'red')
points(x$datetime[which(x$do_temp == -999)], x$do_conc[which(x$do_temp == -999)], 
       pch = 1, col = 'blue')
