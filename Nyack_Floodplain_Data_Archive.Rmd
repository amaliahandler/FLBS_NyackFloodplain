...
anom_do_temp <- lapply(seq_along(gap_fill), function(i){
  # Process for surface water sensors
  if(gap_fill[[i]]$sensor_number[1] == '02' |
     gap_fill[[i]]$sensor_number[1] == '06' |
     gap_fill[[i]]$sensor_number[1] == '08' |
     gap_fill[[i]]$sensor_number[1] == '10' ){
  gap_fill[[i]] %>%  
...
png("./Figures/DO_temp_anomaly_with_surface_well_diff.png", units = "in", 
...
# Is the early data from sensor 01 OK?
