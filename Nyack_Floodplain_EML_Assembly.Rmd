...
file.copy(from = './Data/Nyack_water_sensor_location.csv', 
          to   = './Nyack_Water_EML/data_objects')
...
template_table_attributes(
  ...
  data.table = c('Nyack_do_cleaned.csv', 
                 ...
                 'Nyack_water_sensor_location.csv')
)
...
template_geographic_coverage(
  path = './Nyack_Water_EML/metadata_templates',
  data.path = './Nyack_Water_EML/data_objects',
  data.table = 'Nyack_water_sensor_location.csv',
  site.col = 'site',
  lat.col = 'latitude',
  lon.col = 'longitude'
)
...
make_eml(
  ...
  data.table = c('Nyack_do_cleaned.csv', 'Nyack_cond_cleaned.csv', 'Nyack_level_cleaned.csv', 'Nyack_water_sensor_location.csv'),
  data.table.description = c('Dissolved oxygen data data', 'Conductivity data', 'Water level data', 'Sensor location data'),
  user.id = 'amaliahandler',
  user.domain = 'EDI',
  package.id = 'edi.311.1'
)
