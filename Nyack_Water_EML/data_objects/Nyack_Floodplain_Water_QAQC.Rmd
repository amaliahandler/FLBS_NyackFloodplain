...
# Explanation of column names and units in raw data.
...
bad_data_cond <- rbind(sensor_service_cond, s09_bad_data, na_cond)
...
flag_data_cond <- rbind(s01_glitch[, c('site','sensor_number','datetime',
                        ...
                        s06_glitch[, c('site','sensor_number','datetime',
                                       'cond','cond_temp','ct')],
                        s02_glitch, s08_glitch, zero_cond, anom_low_cond)
...
# Remove the NA data for level_m and level_temp
compiled_level_data[is.na(compiled_level_data$level_m), c('level_m', 'level_temp')] <- c(-999, -999)

# Remove rows that have no datetime information (artifact of daylight savings)
compiled_level_data <- compiled_level_data[!is.na(compiled_level_data$datetime),]
